...
export const BoxContentsSection: React.FC = () => {
  ...
  return (
    <section 
      className="py-10 sm:py-14 lg:py-16 bg-bone border-b border-graphite/10 relative overflow-hidden"
      style={{ backgroundColor: '#FAF8F5', color: '#262320' }}
    >
      {/* Background Texture: Precision Grid (Horizontal Landscape) */}
      <div 
      ...
      >
        <img 
          ...
          alt="" 
          className="w-full h-full object-cover object-center opacity-15 mix-blend-multiply filter contrast-125"
          loading="lazy"
        />
