            ...
            <div className="md:col-span-6 lg:col-span-6 xl:col-span-5 space-y-6">
              ...
              <div className="p-4 sm:p-5 bg-night-950 border border-white/10 flex flex-col sm:flex-row items-center gap-4 sm:gap-6 rounded-xl">
                <div className="flex-shrink-0">
                  <RotatingGuaranteeStamp size={90} />
                </div>
                <div className="space-y-1.5 text-center sm:text-left">
                  <div className="flex items-center justify-center sm:justify-start gap-2">
                    <ShieldCheck className="w-4 h-4 text-accent stroke-[2.5]" />
                    <h4 className="font-display font-bold text-xs sm:text-sm uppercase tracking-wider text-bone">
                      GARANTÍA LEGAL DE 30 DÍAS
                    </h4>
                  </div>
                  <p className="text-xs sm:text-[13px] text-bone/80 leading-relaxed font-medium">
