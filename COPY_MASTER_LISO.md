...
> **Precio oficial:** $149.900 COP (Envío gratis a nivel nacional)  
...
* **Tarjeta de Conversión (Glass Card):**
  ...
  * **Botón principal (CTA):** `Pedir LISO — $149.900`
...
* `Pedir LISO en [Color seleccionado] — $149.900`
...
1. **`/terminos-y-condiciones`**: Marco contractual de compraventa electrónica. Precio final $149.900 COP, medios de pago en línea, despachos en Colombia (15 a 20 días hábiles estimados), perfeccionamiento del pedido y sometimiento a la jurisdicción colombiana.
