# LISO CARE — Documento Maestro de Copywriting (Landing Page Oficial)

> **Mercado:** Colombia 🇨🇴  
> **Producto:** Plancha de vapor portátil LISO (1200 W)  
> **Precio oficial:** $199.900 COP (Envío gratis a nivel nacional)  
> **Identidad de Marca:** Minimalista, editorial, *dark luxury*, transparente y directa.

---

## ÍNDICE DE SECCIONES

1. [Barra Superior de Confianza (TrustBar)](#0-barra-superior-de-confianza-trustbar)
2. [Navegación Principal (Navbar)](#1-navegación-principal-navbar)
3. [Hero Section](#2-hero-section)
4. [DataStrip Técnica (Ficha Rápida)](#3-datastrip-técnica-ficha-rápida)
5. [El Método de los 3 Pasos (Cómo Funciona)](#4-el-método-de-los-3-pasos-cómo-funciona)
6. [Beneficios con Evidencia (3 Momentos)](#5-beneficios-con-evidencia-3-momentos)
7. [Ingeniería Visible (Disección Técnica de 6 Componentes)](#6-ingeniería-visible-disección-técnica)
8. [Etiqueta de Honestidad (Lo que hace y lo que no hace)](#7-etiqueta-de-honestidad)
9. [Comparativa Honesta (LISO vs. Plancha Tradicional vs. Vaporizador)](#8-comparativa-honesta)
10. [Escenas Reales de Uso (Lifestyle)](#9-escenas-reales-de-uso-lifestyle)
11. [Dentro de la Caja (Contenido del Kit)](#10-dentro-de-la-caja-contenido-del-kit)
12. [Prueba Real en Video](#11-prueba-real-en-video)
13. [Sección de Oferta y Cierre Comercial](#12-sección-de-oferta-y-cierre-comercial)
14. [Preguntas Frecuentes (FAQ - 12 Respuestas Oficiales)](#13-preguntas-frecuentes-faq)
15. [CTA Final (Tu ropa lista cuando la necesitas)](#14-cta-final)
16. [Barra de Compra Móvil Persistente (Sticky Buy Bar)](#15-barra-de-compra-móvil-persistente)
17. [Pie de Página (Footer)](#16-pie-de-página-footer)
18. [Resumen de Páginas Legales y Protección al Consumidor](#17-resumen-de-páginas-legales-colombia)

---

## 0. Barra Superior de Confianza (TrustBar)
...
* **Logotipo:** LISO CARE (Edición Original)
* **Enlaces del menú:**
  * Cómo funciona
  * Ingeniería
  * Etiqueta
...
* **Palabra de fondo / marca de agua estructural:** `LISO`
...
* **Tarjeta de Conversión (Glass Card):**
  ...
  * **Botón principal (CTA):** `Pedir LISO — $199.900`
...
## 4. El Método de los 3 Pasos (Cómo Funciona)
...
## 5. Beneficios con Evidencia (3 Momentos)
...
### Momento 02 · CONTROLAR
* **Etiquetas técnicas:** `02 · CONTROLAR` | `2 NIVELES DE VAPOR · MODO SECO`
* **Titular:**
...
* **Subtarjetas de soporte:**
  * **Nivel 1 & 2 de Vapor:** Para sedas, lana, algodón y lino.
  * **Planchado en Seco:** Fijación térmica sin humedad.

---

### Momento 03 · GUARDAR
* **Etiquetas técnicas:** `03 · GUARDAR` | `100 ML ≈ 5 MIN ≈ 2–3 PRENDAS`
* **Titular:**
...
## 6. Ingeniería Visible (Disección Técnica)
...
* **Frase técnica:**
  > Ves la temperatura real: no adivinas si ya está lista.
* **Micro-prueba interactiva:** Lectura térmica en vivo subiendo hasta 150 °C con indicador de 2 niveles y modo seco.
...
## 7. Etiqueta de Honestidad

* **Título:**
  > Te contamos la verdad sobre LISO.
* **Subtítulo:**
  > Lo que hace increíblemente bien, y lo que simplemente no está hecha para hacer.
...
1. **No reemplaza una plancha tradicional:** Si necesitas planchar una montaña de ropa de una sola vez, una plancha convencional es más adecuada.
2. **No está pensada para sesiones largas:** LISO está hecha para resolver esos retoques rápidos, no para estar 30 minutos seguidos planchando.
3. **Su depósito es compacto:** Los 100 ml alcanzan para aproximadamente 2–3 prendas por carga, dependiendo del uso.
...
## 8. Comparativa Honesta

* **Título:**
  > ¿Y cómo se compara con una plancha normal?
* **Subtítulo:**
  > Depende de lo que quieras hacer. Para una pila de ropa, hay herramientas mejores. Para arreglarte rápido antes de salir, LISO juega en otra liga.
...
* **Botón CTA:** `Pedir LISO — $199.900`

---

## 9. Escenas Reales de Uso (Lifestyle)

* **Título:**
  > Hay días en los que sacar la tabla no tiene sentido.
* **Subtítulo:**
  > Una camisa antes de una reunión, una prenda delicada o la ropa que salió arrugada de la maleta. LISO está hecha para esos pequeños rescates del día a día.

### Escena 01 · Camisa de oficina
* **Titular:** La camisa que necesitas, lista en minutos.
* **Contexto:** La cuelgas, pasas LISO y sales sin haber sacado la tabla de planchar.

### Escena 02 · Vestido delicado
* **Titular:** Si tienes poco tiempo antes de salir, una arruga no debería complicarte el día.
* **Contexto:** Vapor para las zonas más difíciles y placa caliente para dejar la prenda realmente lisa.
...
## 10. Dentro de la Caja (Contenido del Kit)
...
## 12. Sección de Oferta y Cierre Comercial

* **Etiqueta superior:** `OFERTA OFICIAL COLOMBIA · KIT COMPLETO`
* **Nombre de producto:** Plancha de vapor portátil LISO
* **Precio:**
  * **Antes (referencial):** `$300.000`
  * **Ahora:** `$199.900 COP`
...
* `🇨🇴 Enchufe estándar para Colombia`
* `✓ Clavija plana Tipo A/B · Conexión directa a la pared sin adaptadores (110 V)`

### Tarjeta de Garantía Legal Oficial:
* **Sello giratorio:**
  * Texto circular: `★ GARANTÍA LEGAL ★ COMPRA PROTEGIDA`
  * Centro: `30 DÍAS`
* **Título de la tarjeta:** `GARANTÍA LEGAL DE 30 DÍAS`
* **Texto:**
...
* `Pedir LISO en [Color seleccionado] — $199.900`
...
### Línea de Políticas bajo la Oferta:
> Compra segura · Envíos nacionales (15–20 días hábiles) · Garantía legal · [Consulta nuestras políticas]
...
* **Subtítulo:** Respuestas claras y directas a lo que todos nos preguntamos antes de comprar.

### 01. ¿Cuánto dura el tanque de agua?
...
* **Marca de agua estructural:** `SIN TABLA`
* **Titular Principal (H2):**
  > Tu ropa lista cuando la necesitas.
* **Subtítulo:**
...
## 15. Barra de Compra Móvil Persistente

*(Se despliega automáticamente en celulares tras superar los primeros 450px de scroll)*

* **Precio visible:** `$199.900`
...
* **Columna 1: Marca & Identidad**
  * `LISO — EDICIÓN ORIGINAL`
  * Tagline: *"El planchado que sí vas a usar."*
  * Concepto: *"La verdad plancha mejor."*
* **Columna 2: Especificaciones Clave**
  * Potencia: 1200 W
  * Voltaje: 110 V (red doméstica Colombia)
  * Tanque: 100 ml (~5 min)
  * Temperatura: hasta 150 °C
  * Garantía: 30 días calendario (Garantía Legal)
* **Columna 3: Atención & Soporte**
  * Preguntas Frecuentes
  * Etiqueta de Honestidad
  * Envíos nacionales (15–20 días hábiles estimados)
  * Atención: `atencion.lisostore@gmail.com`
  * Radicar PQR / Atención al Cliente → (`/pqr`)
* **Columna 4: Marco Legal Colombia**
  * Términos y condiciones (`/terminos-y-condiciones`)
  * Privacidad y tratamiento de datos (`/politica-de-privacidad`)
  * Garantía (30 días calendario) (`/garantia`)
  * Retracto y devoluciones (`/retracto-y-devoluciones`)
  * Reversión del pago (`/reversion-del-pago`)
...
## 17. Resumen de Páginas Legales (Colombia)

1. **`/terminos-y-condiciones`**: Marco contractual de compraventa electrónica. Precio final $199.900 COP, medios de pago en línea, despachos en Colombia (15 a 20 días hábiles estimados), perfeccionamiento del pedido y sometimiento a la jurisdicción colombiana.
2. **`/politica-de-privacidad`**: Política de Tratamiento de Datos Personales bajo la Ley 1581 de 2012. Finalidades (despacho, facturación, soporte postventa), derechos de los titulares (conocer, actualizar, rectificar y revocar autorización) y tiempos de respuesta legal (10–15 días hábiles).
3. **`/garantia`**: Garantía legal de treinta (30) días calendario contados desde la entrega física por defectos de fábrica o funcionamiento a 110 V. Diagnóstico de 3 a 5 días hábiles, cobertura total de fletes por LISO en casos procedentes, causales de exoneración legal (mal uso, golpes, líquidos corrosivos).
4. **`/retracto-y-devoluciones`**: Derecho de retracto bajo el Art. 47 de la Ley 1480 de 2011. Término de 5 días hábiles siguientes a la entrega, producto sin uso y en empaque original. Devolución del dinero en un plazo máximo de 15 días calendario.
5. **`/reversion-del-pago`**: Procedimiento del Decreto 587 de 2016 y Art. 51 de la Ley 1480. Cinco causales legales (fraude, operación no solicitada, producto no recibido, defectuoso o no correspondiente). Notificación dual simultánea dentro de los 5 días hábiles ante LISO y la entidad bancaria.
6. **`/envios`**: Despacho nacional gratuito a toda Colombia. Plazo estimado de 15 a 20 días hábiles según la logística nacional, asignación de guía y seguimiento en línea continuo hasta la puerta del cliente.
7. **`/pqr`**: Canal y formulario interactivo para radicar Peticiones, Quejas y Reclamos. Generación automática de radicado único (`LISO-PQR-YYYYMMDD-XXXX`), confirmación por correo y término legal máximo de respuesta de 15 días hábiles (CPACA y Ley 1480).
